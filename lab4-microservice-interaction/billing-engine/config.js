...
const KAFKA_PRODUCE_TOPIC= "questions-topic"
const KAFKA_WORKFLOW_TOPIC = "workflow-queue"
const KAFKA_ANSWERS_TOPIC =  "answers-topic"
const KAFKA_CONSUME_TOPICS =  [KAFKA_WORKFLOW_TOPIC, KAFKA_ANSWERS_TOPIC]
...
module.exports = { kafkaConfig, KAFKA_WORKFLOW_TOPIC, KAFKA_ANSWERS_TOPIC, KAFKA_PRODUCE_TOPIC, KAFKA_CONSUME_TOPICS };